        ...
        <form className="space-y-8">
          ...
          <div className="relative">
            <input
              ...
              id="name"
              required
              className="peer w-full bg-transparent border-2 border-white text-white font-bold rounded-xl px-5 pt-6 pb-2 placeholder-transparent focus:outline-none focus:ring-2 focus:ring-white transition-all"
